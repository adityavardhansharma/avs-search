// Identical port of ../../src/pages/api/suggestions.ts (Astro) as a Nuxt
// server route. Same tunables, same TTL-LRU, same prefix fast-path, same
// DuckDuckGo upstream, same inflight coalescing, same cache headers.
